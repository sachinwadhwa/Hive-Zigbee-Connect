...
def poll() {
  ...
  //  https://github.com/KristopherKubicki/device-type.http-ping/blob/master/http-ping.devicetype.groovy
...
private String convertHexToIP(hex) {
  log.debug("Convert hex to ip: $hex")[convertHexToInt(hex[0. .1]), convertHexToInt(hex[2. .3]), convertHexToInt(hex[4. .5]), convertHexToInt(hex[6. .7])].join(".")
}
